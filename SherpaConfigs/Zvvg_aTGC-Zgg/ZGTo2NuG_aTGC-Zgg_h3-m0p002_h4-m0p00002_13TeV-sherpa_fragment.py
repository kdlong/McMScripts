...
generator = cms.EDFilter("SherpaGeneratorFilter",
    SherpaProcess = cms.string('m0p002Im0p00002'),
    ...
    SherpackChecksum = cms.string('65542a53d3183e56d158d789b8c2e5e0'),
    SherpaResultDir = cms.string('Result'),
    SherpaPath = cms.string('./'),
    crossSection = cms.untracked.double(-1),
    maxEventsToPrint = cms.int32(0),
    SherpaPathPiece = cms.string('./'),
    SherpackLocation = cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc481/13TeV/sherpa/V2.1.1/Znunug_aTGC_Zgg'),
